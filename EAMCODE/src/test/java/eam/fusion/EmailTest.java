...
public class EmailTest {  
    ...
    private EmailTest(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,  
     ...
     * @return 
     */  
    public static EmailTest entity(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,  
            List<String> attachments) {  
        return new EmailTest(smtpHost, sendUserName, sendUserPass, to, cc, mailSubject, mailBody, attachments);  
    }  
     ...
     * @return 
     */  
    public static EmailTest defaultEntity(String to, String cc, String subject, String body, List<String> attachments) {  
        return new EmailTest(defaultSmtpHost, defaultSenderName, defaultSenderPass, to, cc, subject, body, attachments);  
    }  
    ...
    public static void main(String[] args) throws Exception {
        ...
        String name1 = ChineseToEnglish.getPingYin("赵强.巫")+"@fuyaogroup.com";
        String name2 = ChineseToEnglish.getPingYin("淋.王")+"@fuyaogroup.com";
        
        String to =name1+","+name2; // 收件人，多个收件人以半角逗号分隔  
        ...
        List<String> attachments = Arrays.asList(""); // 附件的路径，多个附件也不怕  C:\\Users\\gnb781\\Desktop\\01.jpg", "C:\\Users\\gnb781\\Desktop\\集团未盘点名单.xls
  
        EmailTest email = EmailTest.entity(smtpHost, userName, password, to, cc, subject, body, attachments);  
