...
<form name="uploadform" id="uploadform" action="/eam/bookApprove" method="POST">
	 <div class="animated">
	<div id="title-pd">借阅</div>
	<p></p>
	<div class="field-wrapper" ><label>工号</label><input   class="input-style" type="text" name="userid" value="${userid}"  readonly	/></div>
	<div class="field-wrapper" ><label>姓名</label><input   class="input-style" type="text" name="userName" value="${userName}"  readonly	/></div>
	<div class="field-wrapper" ><label>书名</label><input  id="thingName"  class="input-style" type="text" name="thingName" value="${thingName}"	readonly/></div>
