...
public class Email {  
    ...
    public static void main(String[] args) throws Exception {
        ...
        String to = "zhaoqiang.wu@fuyaogroup.com"; // 收件人，多个收件人以半角逗号分隔  
        String cc = "plm_system@fuyaogroup.com"; // 抄送，多个抄送以半角逗号分隔  
        String subject = "计算机未盘点，是否丢失"; // 主题  
        String body = "{测试批次盘点}您的计算机等资产还未在指定时间内盘点，是否丢失？请尽快在微信上盘点，负责财务可能做盘亏处理"; // 正文，可以用html格式的哟  
        List<String> attachments = Arrays.asList("C:\\Users\\gnb781\\Desktop\\01.jpg", "C:\\Users\\gnb781\\Desktop\\集团未盘点名单.xls"); // 附件的路径，多个附件也不怕  
