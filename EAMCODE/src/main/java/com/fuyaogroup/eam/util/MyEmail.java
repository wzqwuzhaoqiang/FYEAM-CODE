...
public class MyEmail {
    ...
    private MyEmail(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,  
     ...
     * @return 
     */  
    public static MyEmail entity(String smtpHost, String sendUserName, String sendUserPass, String to, String cc, String mailSubject, String mailBody,  
            List<String> attachments) {  
        return new MyEmail(smtpHost, sendUserName, sendUserPass, to, cc, mailSubject, mailBody, attachments);  
    }  
     ...
     * @return 
     */  
    public static MyEmail defaultEntity(String to, String cc, String subject, String body, List<String> attachments) {  
        return new MyEmail(defaultSmtpHost, defaultSenderName, defaultSenderPass, to, cc, subject, body, attachments);  
    }  
    ...
    private boolean setCC(String cc) {  
        ...
        try {  
        	InternetAddress[] internetAddressBCC = new InternetAddress().parse(cc);
            mimeMsg.setRecipients(Message.RecipientType.BCC,internetAddressBCC);  
        } catch (Exception e) {  
            return false;  
        }  
        return true;  
